...
const ProductList = () => {
  ...
  }, [handelRemoveProduct, handelEditProduct]);
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div className="lg:col-span-3">
                    ...
                    <Link
                      ...
                      className="p-2 bg-green-600 rounded-md text-white font-bold"
                    >
                      New Product
                    </Link>
                              ...
                              <div className="relative ">
                                ...
                                <div className="absolute top-0 flex-col">
                                  <div
                                    ...
                                    className="p-2 cursor-pointer bottom-0 rounded-md text-white font-bold  "
                                  >
                                    ❌
                                  </div>
                                  <Link
